var Formula=[
    //id1,id2,id3,名称，攻击力，血量，法力，法强，攻速,护甲,魔抗，备注
       ...
       ["1001","1001","2001","无尽之刃","40","0","0","0","0","0","0","暴击伤害+150%"],
       ["1001","1002","2002","神圣之剑","20","0","0","0","20","0","0","每秒有5%几率获得100%暴击几率"],
       ["1001","1003","2005","海克斯的科技枪","20","0","0","20","0","0","0","33%全能吸血，但是不包括物品造成的伤害"],
       ["1001","1004","2006","朔极之矛","20","0","20","0","0","0","0","第一次释放技能后，普通攻击恢复15%最大法力"],
       ["1001","1005","2003","守护天使","20","0","0","0","0","20","0","死亡2秒后清除重伤效果，恢复1000血量"],
       ...
       ["1002","1003","2012","鬼索的狂暴之刃","0","0","0","20","20","0","0","每次攻击增加8%攻速"],
       ["1002","1004","2010","斯塔缇克电刃","0","0","20","0","20","0","0","每三次攻击对目标和额外三个目标造成100魔法伤害"],
       ["1002","1005","2013","幻影之舞","0","0","0","0","20","20","0","闪避所有暴击(无法闪避火炮)"],
       ...
       ["1003","1005","2020","钢铁烈焰之匣","0","0","0","20","0","20","0","每次攻击增加8%攻速"],
       ["1003","1006","2018","离子火花","0","0","0","20","0","0","20","敌人释放技能会受到200真实伤害"],
       ["1003","1007","2022","莫雷洛秘典","0","200","0","20","0","0","0","技能造成5秒燃烧，每秒受到5%最大生命值真实伤害，并无法被治疗"],
       ...
       ["1004","1006","2027","肃静","0","0","20","0","0","0","20","普攻有50%几率沉默对方5秒"],
       ["1004","1007","2025","救赎","0","200","20","0","0","0","0","生命值下降到25%时候创造区域，在小段延迟后治疗区域内1000血量"],
       ["1004","1008","2023","暗裔","0","0","40","0","0","0","0","携带者获得恶魔羁绊"],
       ["1005","1005","2029","荆棘之甲","0","0","0","0","0","40","0","反弹所减免伤害的100%的真实伤害"],
       ["1005","1006","2031","折剑者","0","0","0","0","0","20","20","攻击有25%几率缴械目标4秒"],
       ["1005","1007","2030","蜥蜴长老之赐","0","200","0","0","0","20","0","普攻造成5秒燃烧，每秒受到2.5%最大生命值真实伤害，并无法被治疗"],
       ...
       ["1006","1008","2034","卢安娜的飓风","0","0","0","0","0","0","40","普攻对额外1个目标造成伤害，额外攻击造成25%的伤害，附带普攻特效"],
...
var synergys=[
    ["恶魔","剑魔,火男,蜘蛛,寡妇,莫甘娜,乌鸦,维鲁斯","攻击时有几率燃烧掉敌方法力,并造成法力燃烧量的真实伤害",[["2","燃烧几率25%"],["4","燃烧几率35%"],["6","燃烧几率85%"]]],
    ...
    ["忍者","阿卡丽,凯南,慎,劫","忍者只有在1个或者4个在场才生效，增加攻击",[["正好1个","伤害+40%"],["正好4个","伤害+80%"]]],
    ["贵族","剑姬,盖伦,天使,蕾欧娜,卢锡安,薇恩","受到加持的人获得100护甲,普通攻击回复35血量",[["3","一个随机的在场英雄"],["6","所有在场英雄"]]],
    ...
    ["虚空","卡萨丁,大虫子,挖掘机，螳螂","普攻获得护甲穿透",[["3","在场英雄获得50%护甲穿透"]]],
    ["狂野","阿狸,纳尔,豹女,狮子狗,狼人","攻击命中时增加10%攻速，最多叠加50%",[["2","对狂野单位生效"],["4","对所有单位生效"]]],
    ["约德尔人","纳尔,凯南,露露,波比,小炮,小法","有几率闪避普攻",[["3","闪避几率30%"],["6","闪避几率55%"]]],
    ["法师","卡萨丁,卡牌,露露,阿狸,小法,莫甘娜,龙王,死亡歌颂者","技能强度获得提高",[["3","增强45%"],["6","增强100%"]]],
    ["刺客","寡妇,卡特琳娜,阿卡丽,劫,派克,螳螂,狮子狗","刺客单位获得额外爆伤",[["3","爆伤+125%"],["6","爆伤+350%"]]],
    ["剑士","剑魔,亚索,德莱文,剑姬,慎,船长","有45%几率打出额外攻击",[["3","额外攻击1次"],["6","额外攻击两次"]]],
    ["斗士","狗熊,机器人,大虫子,挖掘机,狼人","斗士获得额外最大生命值",[["2","最大生命+300"],["4","最大生命+700"]]],
    ["元素使","火男,冰鸟,丽桑卓,凯南","开局时候召唤一个元素之灵",[["3","召唤一个攻击100血量2200的元素之灵"]]],
    ["护卫","布隆,蕾欧娜","战斗开始时候护卫和附近友军获得护甲,可叠加",[["2","获得40护甲"]]],
    ["枪手","卢锡安,女枪,船长,小炮,男枪","枪手普攻有50%几率进行额外打击",[["2","额外打击一个目标"],["4","额外打击3个目标"]]],
    ["骑士","猪妹,诺手,天使,盖伦,莫歌凯撒,波比","骑士格挡普攻伤害",[["2","格挡20伤害"],["4","格挡40伤害"],["6","格挡80伤害"]]],
    ["游侠","维鲁斯,寒冰,薇恩,千珏","每3秒有几率攻速翻倍,持续3秒",[["2","翻倍几率25%"],["4","翻倍几率65%"]]],
    ["换形师","乌鸦,蜘蛛,龙女,纳尔,豹女","变形时获得额外最大生命值",[["3","获得60%额外最大生命值"]]]
